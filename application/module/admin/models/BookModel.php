...
class BookModel extends Model{
	...
	public function changeStatus($arrParam, $option = null){
		...
		if($option['task'] == 'change-status'){
			...
			if(!empty($arrParam['cid'])){
				...
				$this->query($query);
				Session::set('message', array('class' => 'success', 'content' => 'Có ' . $this->affectedRows(). ' element is state changed!'));
			}else{
				Session::set('message', array('class' => 'error', 'content' => 'Please select the element you want to change the state!'));
			}
		}
	}
	...
	public function deleteItem($arrParam, $option = null){
		if($option == null){
			if(!empty($arrParam['cid'])){
				...
				Session::set('message', array('class' => 'error', 'content' => 'Please select the element you want to delete!'));
			}
		}
	}
	...
	public function saveItem($arrParam, $option = null){
		...
		if($option['task'] == 'add'){
			echo $arrParam['form']['picture']	= $uploadObj->uploadFile($arrParam['form']['picture'], 'book', 98, 150);
		...
		if($option['task'] == 'edit'){
			echo $arrParam['form']['picture']['name'];
	...
	public function ordering($arrParam, $option = null){
		if($option == null){
			if(!empty($arrParam['order'])){
				...
				Session::set('message', array('class' => 'success', 'content' => 'Có ' .$i. ' element is changed ordering!'));
			}
		}
	}
}