	...
	public function changeStatus($arrParam, $option = null){
		...
		if($option['task'] == 'change-status'){
			...
			if(!empty($arrParam['cid'])){
				...
				$this->query($query);
				Session::set('message', array('class' => 'success', 'content' => 'Yes' . $this->affectedRows(). ' element is changed state!'));
			}else{
	...
	public function deleteItem($arrParam, $option = null){
		if($option == null){
			if(!empty($arrParam['cid'])){
				...
				$this->query($query);
				Session::set('message', array('class' => 'success', 'content' => 'Yes' . $this->affectedRows(). ' element is deleted!'));
			}else{
	...
	public function ordering($arrParam, $option = null){
		if($option == null){
			if(!empty($arrParam['order'])){
				...
				Session::set('message', array('class' => 'success', 'content' => 'Yes' .$i. ' element is changed ordering!'));
			}
		}
	}
}